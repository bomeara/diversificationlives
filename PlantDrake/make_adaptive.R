...
make(plan_adaptive, parallelism = "future", jobs = parallel::detectCores(), cache=drake::new_cache("~/Documents/localcache"), keep_going=TRUE, lock_envir=FALSE) # cache so that they don't all try writing to same cache
