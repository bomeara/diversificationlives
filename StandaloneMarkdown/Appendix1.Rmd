...
knitr::opts_chunk$set(echo = FALSE, warning=FALSE, message=FALSE, cache=TRUE, fig.width=7, fig.height=5)
set.seed(1859)
```
...
backbone <- ape::compute.brlen(ape::stree(2^power, type="balanced"), method=3)
